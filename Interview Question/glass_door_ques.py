...
# with open(r"C:\Users\HP\PycharmProjects\selenium\pytestDemo\python question.txt","r",encoding="utf-8") as f:
#     p=f.readlines()
#
# st="containing"
#
...
# def check(list1):
#     list1.sort()
#     if list1[1]-list1[0]==6 or list1[0]==6 or list1[1]==6 or list1[0]+list1[1]==6:
#         return True
#     else:
#         return False
#
